...
class ApiController extends BaseController
{
    ...
    function dataFileter($table,$input,$function){
        ...
        foreach ($tableConfig["fields"] as $key => $value) {
            ...
            if(!in_array($fieldName,$inputKeys) || !isset($input[$fieldName])){
    ...
    public function upload(Request $request){
        if ($file = UploadRequest::file('file')) {
            ...
            $folderType     = in_array($fileExtension, ["png", "jpg", "gif","PNG","JPG","GIF"])?"images":"files";
            ...
            if($folderType == "images"){
                $newImg = $this->thumb($file,$serverPath.$fileName,'500','500');
            }else{
